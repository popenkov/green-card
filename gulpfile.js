...
gulp.task("js", function () {
  ...
  return gulp
    .src(["app/js/**/*.js", "!app/js/**/_*.js", "!app/js/libs*.js"])
    .pipe(
      plumber({
        errorHandler: notify.onError((err) => ({
          title: "JS",
...
gulp.task("minify", function () {
  return gulp
    .src(["dist/css/*.css", "!dist/css/libs.min.css"])
    .pipe(cssnano())
    .pipe(gulp.dest("dist/css"));
});
...
gulp.task(
  ...
  gulp.series(
    "clean",
    "svg",
    gulp.parallel("assets", "html", "css", "css-libs", "js", "js-libs")
  )
);
gulp.task(
  "default",
  gulp.series("create", gulp.parallel("webserver", "watch"))
);
